...
func (p GrantType) String() string {
  switch p {
  case GrantType_DEVELOPER: return "GrantType_DEVELOPER"
  case GrantType_APP_ROOT: return "GrantType_APP_ROOT"
  case GrantType_APP_USER: return "GrantType_APP_USER"
  case GrantType_GUEST: return "GrantType_GUEST"
  }
  return "<UNSET>"
}
...
func GrantTypeFromString(s string) (GrantType, error) {
  switch s {
  case "GrantType_DEVELOPER": return GrantType_DEVELOPER, nil 
  case "GrantType_APP_ROOT": return GrantType_APP_ROOT, nil 
  case "GrantType_APP_USER": return GrantType_APP_USER, nil 
  case "GrantType_GUEST": return GrantType_GUEST, nil 
  }
