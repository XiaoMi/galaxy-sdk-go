...
func (p HttpStatusCode) String() string {
  switch p {
  case HttpStatusCode_BAD_REQUEST: return "HttpStatusCode_BAD_REQUEST"
  case HttpStatusCode_INVALID_AUTH: return "HttpStatusCode_INVALID_AUTH"
  case HttpStatusCode_CLOCK_TOO_SKEWED: return "HttpStatusCode_CLOCK_TOO_SKEWED"
  case HttpStatusCode_REQUEST_TOO_LARGE: return "HttpStatusCode_REQUEST_TOO_LARGE"
  case HttpStatusCode_INTERNAL_ERROR: return "HttpStatusCode_INTERNAL_ERROR"
  }
  return "<UNSET>"
}
...
func HttpStatusCodeFromString(s string) (HttpStatusCode, error) {
  switch s {
  case "HttpStatusCode_BAD_REQUEST": return HttpStatusCode_BAD_REQUEST, nil 
  case "HttpStatusCode_INVALID_AUTH": return HttpStatusCode_INVALID_AUTH, nil 
  case "HttpStatusCode_CLOCK_TOO_SKEWED": return HttpStatusCode_CLOCK_TOO_SKEWED, nil 
  case "HttpStatusCode_REQUEST_TOO_LARGE": return HttpStatusCode_REQUEST_TOO_LARGE, nil 
  case "HttpStatusCode_INTERNAL_ERROR": return HttpStatusCode_INTERNAL_ERROR, nil 
  }
...
func (p ErrorCode) String() string {
  switch p {
  case ErrorCode_INTERNAL_ERROR: return "ErrorCode_INTERNAL_ERROR"
  case ErrorCode_SERVICE_UNAVAILABLE: return "ErrorCode_SERVICE_UNAVAILABLE"
  case ErrorCode_UNKNOWN: return "ErrorCode_UNKNOWN"
  case ErrorCode_END_OF_INTERNAL_ERROR: return "ErrorCode_END_OF_INTERNAL_ERROR"
  case ErrorCode_ACCESS_DENIED: return "ErrorCode_ACCESS_DENIED"
  case ErrorCode_VALIDATION_FAILED: return "ErrorCode_VALIDATION_FAILED"
  case ErrorCode_SIZE_EXCEED: return "ErrorCode_SIZE_EXCEED"
  case ErrorCode_QUOTA_EXCEED: return "ErrorCode_QUOTA_EXCEED"
  case ErrorCode_THROUGHPUT_EXCEED: return "ErrorCode_THROUGHPUT_EXCEED"
  case ErrorCode_RESOURCE_NOT_FOUND: return "ErrorCode_RESOURCE_NOT_FOUND"
  case ErrorCode_RESOURCE_ALREADY_EXISTS: return "ErrorCode_RESOURCE_ALREADY_EXISTS"
  case ErrorCode_RESOURCE_UNAVAILABLE: return "ErrorCode_RESOURCE_UNAVAILABLE"
  case ErrorCode_UNSUPPORTED_VERSION: return "ErrorCode_UNSUPPORTED_VERSION"
  case ErrorCode_UNSUPPORTED_OPERATION: return "ErrorCode_UNSUPPORTED_OPERATION"
  case ErrorCode_INVALID_AUTH: return "ErrorCode_INVALID_AUTH"
  case ErrorCode_CLOCK_TOO_SKEWED: return "ErrorCode_CLOCK_TOO_SKEWED"
  case ErrorCode_REQUEST_TOO_LARGE: return "ErrorCode_REQUEST_TOO_LARGE"
  case ErrorCode_BAD_REQUEST: return "ErrorCode_BAD_REQUEST"
  case ErrorCode_TTRANSPORT_ERROR: return "ErrorCode_TTRANSPORT_ERROR"
  case ErrorCode_UNSUPPORTED_TPROTOCOL: return "ErrorCode_UNSUPPORTED_TPROTOCOL"
  case ErrorCode_REQUEST_TIMEOUT: return "ErrorCode_REQUEST_TIMEOUT"
  }
  return "<UNSET>"
}
...
func ErrorCodeFromString(s string) (ErrorCode, error) {
  switch s {
  case "ErrorCode_INTERNAL_ERROR": return ErrorCode_INTERNAL_ERROR, nil 
  case "ErrorCode_SERVICE_UNAVAILABLE": return ErrorCode_SERVICE_UNAVAILABLE, nil 
  case "ErrorCode_UNKNOWN": return ErrorCode_UNKNOWN, nil 
  case "ErrorCode_END_OF_INTERNAL_ERROR": return ErrorCode_END_OF_INTERNAL_ERROR, nil 
  case "ErrorCode_ACCESS_DENIED": return ErrorCode_ACCESS_DENIED, nil 
  case "ErrorCode_VALIDATION_FAILED": return ErrorCode_VALIDATION_FAILED, nil 
  case "ErrorCode_SIZE_EXCEED": return ErrorCode_SIZE_EXCEED, nil 
  case "ErrorCode_QUOTA_EXCEED": return ErrorCode_QUOTA_EXCEED, nil 
  case "ErrorCode_THROUGHPUT_EXCEED": return ErrorCode_THROUGHPUT_EXCEED, nil 
  case "ErrorCode_RESOURCE_NOT_FOUND": return ErrorCode_RESOURCE_NOT_FOUND, nil 
  case "ErrorCode_RESOURCE_ALREADY_EXISTS": return ErrorCode_RESOURCE_ALREADY_EXISTS, nil 
  case "ErrorCode_RESOURCE_UNAVAILABLE": return ErrorCode_RESOURCE_UNAVAILABLE, nil 
  case "ErrorCode_UNSUPPORTED_VERSION": return ErrorCode_UNSUPPORTED_VERSION, nil 
  case "ErrorCode_UNSUPPORTED_OPERATION": return ErrorCode_UNSUPPORTED_OPERATION, nil 
  case "ErrorCode_INVALID_AUTH": return ErrorCode_INVALID_AUTH, nil 
  case "ErrorCode_CLOCK_TOO_SKEWED": return ErrorCode_CLOCK_TOO_SKEWED, nil 
  case "ErrorCode_REQUEST_TOO_LARGE": return ErrorCode_REQUEST_TOO_LARGE, nil 
  case "ErrorCode_BAD_REQUEST": return ErrorCode_BAD_REQUEST, nil 
  case "ErrorCode_TTRANSPORT_ERROR": return ErrorCode_TTRANSPORT_ERROR, nil 
  case "ErrorCode_UNSUPPORTED_TPROTOCOL": return ErrorCode_UNSUPPORTED_TPROTOCOL, nil 
  case "ErrorCode_REQUEST_TIMEOUT": return ErrorCode_REQUEST_TIMEOUT, nil 
  }
...
func (p RetryType) String() string {
  switch p {
  case RetryType_SAFE: return "RetryType_SAFE"
  case RetryType_UNSAFE: return "RetryType_UNSAFE"
  }
  return "<UNSET>"
}
...
func RetryTypeFromString(s string) (RetryType, error) {
  switch s {
  case "RetryType_SAFE": return RetryType_SAFE, nil 
  case "RetryType_UNSAFE": return RetryType_UNSAFE, nil 
  }
